...
public class DataEntryNew
{
	...
	public static void main(String[] args) throws IOException
	{
           ...
           for(Employee x:Emplist)
           	 x.displayEmpRecord();
           Pobj1.incrementsalary();
           Pobj2.incrementsalary();
           Pobj3.incrementsalary();
           Pobj4.incrementsalary();
           Pobj5.incrementsalary();
           System.out.println("The details after incrementation are ");
           ArrayList<Employee> EmpList=new ArrayList<>();
           Mobj1.storeEmpRecord(EmpList);
           Mobj2.storeEmpRecord(EmpList);
           Mobj3.storeEmpRecord(EmpList);
